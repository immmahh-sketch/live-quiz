...
const need = (slug) => { const c = counts[slug] || {}; const out = {}; for (const [t, n] of Object.entries(GOAL)) { if (SIGNATURE.has(slug) && !["choice", "text"].includes(t)) continue; out[t] = Math.max(0, n - (c[t] || 0)); } return out; };
