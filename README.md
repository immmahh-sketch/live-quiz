...
| The Race | Played on the phones: a bank of quick multiple-choice questions, answer or skip, first to the target (default 10 right) wins | Winner takes the prize (default 5000), last place loses the forfeit (default 2000), nobody else scores; you're out once you can't reach the target; on the time limit the clear leader wins |
